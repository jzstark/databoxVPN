...
docker run -v  $OVPN_DATA:/etc/openvpn --rm -it $IMAGE easyrsa build-client-full $CLIENT nopass

# Retrieve the client configuration with embedded certificates
docker run -v  $OVPN_DATA:/etc/openvpn --rm $IMAGE ovpn_getclient $CLIENT> $CLIENT.ovpn
